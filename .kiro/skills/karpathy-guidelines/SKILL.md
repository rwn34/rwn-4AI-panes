---
name: karpathy-guidelines-examples
description: Worked examples of the four Karpathy coding guidelines — Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution. Anti-pattern vs fix contrasts across validation, sorting, rate limiting, and more. Use when reviewing code, explaining why an approach is overcomplicated, or demonstrating surgical vs drive-by edits. The four principles themselves are always loaded via `.kiro/steering/karpathy-guidelines.md`.
---

<!-- Kiro skill: loaded on-demand when the description matches the task. -->
<!-- Default-agent loads this via skill://.kiro/skills/*/SKILL.md — custom agents must declare this URI explicitly. -->
<!-- SSOT: .ai/instructions/karpathy-guidelines/examples.md — regenerate via .ai/sync.md -->
...
For the principles themselves, see `principles.md` in this folder.
